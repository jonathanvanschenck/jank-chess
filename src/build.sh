...
g++ -Wall -std=c++11 -c Game.cpp BBoard.cpp Board.cpp Attack.cpp FindMagic.cpp Magic.cpp Zobrist.cpp Move.cpp Transposition.cpp
g++ -Wformat=0 -std=c++11 -c server.cpp 
g++ -std=c++11 -o server.bin server.o Game.o Board.o BBoard.o Attack.o FindMagic.o Magic.o Move.o Zobrist.o Transposition.o
# ./server.bin
